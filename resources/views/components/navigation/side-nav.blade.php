            ...
            <li class="menu-item">
                ...
                <ul class="collapse list-unstyled {{$category === 'animals' ? 'show' : ''}}" id="animalsSubmenu">
                    <li class="menu-sub-item {{$subcategory === 'birds' ? 'active' : ''}}">
                        <a href="{{route('admin.animals.birds')}}"><span class="menu-sub-item-text">Birds</span></a>
                    </li>
                    <li class="menu-sub-item {{$subcategory === 'fishes' ? 'active' : ''}}">
                        <a href="{{route('admin.animals.fishes')}}"><span class="menu-sub-item-text">Fishes</span></a>
                    </li>
                    <li class="menu-sub-item {{$subcategory === 'mammals' ? 'active' : ''}}">
                        <a href="{{route('admin.animals.mammals')}}"><span class="menu-sub-item-text">Mammals</span></a>
                    </li>
                    <li class="menu-sub-item {{$subcategory === 'reptiles' ? 'active' : ''}}">
                        <a href="{{route('admin.animals.reptiles')}}"><span class="menu-sub-item-text">Reptiles</span></a>
                    </li>
                </ul>
            </li>
