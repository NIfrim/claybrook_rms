                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name = "title" id = "title" class="form-control @error('title') is-invalid @enderror" required autocomplete="title" autofocus>
                                        ...
                                        <option value = "MR" selected="{{old('title') && old('title') === 'MR'}}">Mr</option>
                                        <option value = "MRS" selected="{{old('title') && old('title') === 'MRS'}}">Mrs</option>
                                        <option value = "MISS" selected="{{old('title') && old('title') === 'MISS'}}">Miss</option>
                                        <option value = "MS" selected="{{old('title') && old('title') === 'MS'}}">Ms</option>
                                        <option value = "MX" selected="{{old('title') && old('title') === 'MX'}}">Mx</option>
                                    </select>
