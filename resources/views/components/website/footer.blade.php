...
<div class="footer-bottom">
	<div class="container d-flex justify-content-between">
		...
		<div class="d-flex flex-column justify-content-between">
			...
			<p>{{$zoo['name']}}, {{$zoo['address']['building_number']}} {{$zoo['address']['road_name']}}, {{$zoo['address']['city']}}, {{$zoo['address']['county']}}, {{$zoo['address']['postcode']}}</p>
			
			<p>Registered Company No.{{$zoo['company_number']}}</p>
		</div>
