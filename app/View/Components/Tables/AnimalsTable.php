...
class AnimalsTable extends DefaultTable
{
	...
	protected function getColumns()
	{
		$columns = [
			...
			['name' => 'height_current', 'title' => 'height current', 'type' => 'number'],
			['name' => 'weight_joined', 'title' => 'weight joined', 'type' => 'number'],
			['name' => 'weight_current', 'title' => 'weight current', 'type' => 'number'],
			['name' => 'diet', 'title' => 'diet', 'type' => 'text'],
			['name' => 'did_you_know', 'title' => 'did you know', 'type' => 'text'],
